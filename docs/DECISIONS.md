...
| M12 | **The rectangle is what travels, not a point.** A line is only usable if the whole body sweeps along it clear — the traced collider, not its centre. Planning at 2 m of clearance for a body 40 m wide finds gaps that do not exist and then blames whatever is standing in one. | ❌ new |
